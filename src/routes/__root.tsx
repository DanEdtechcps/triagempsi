...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Triagem Psiquiátrica — Avaliação pré-consulta" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Triagem Psiquiátrica" },
      { property: "og:title", content: "Triagem Psiquiátrica — Avaliação pré-consulta" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:wght@500;600;700&family=Instrument+Serif:ital@0;1&family=Inter:wght@400;500;600;700&display=swap",
      },
...
function useRecoveryLinkRedirect() {
  useEffect(() => {
